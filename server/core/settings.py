...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-j-%n2lm@1rm#qa*se)r7daklsujt4z3yh%rb_ws_#z5bo2k)$k')
...
# Email (для OTP — подтверждение регистрации и сброс пароля)
# В режиме разработки (EMAIL_BACKEND не задан) коды печатаются в консоль сервера.
# Для production задайте переменные EMAIL_HOST, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD в .env.local
EMAIL_BACKEND = os.getenv('EMAIL_BACKEND', 'django.core.mail.backends.console.EmailBackend')
EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.gmail.com')
EMAIL_PORT = int(os.getenv('EMAIL_PORT', '465'))
EMAIL_USE_SSL = os.getenv('EMAIL_USE_SSL', 'False').lower() == 'true'
EMAIL_USE_TLS = False if EMAIL_USE_SSL else (os.getenv('EMAIL_USE_TLS', 'True').lower() == 'true')
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'ФураЕдет <noreply@furaedет.ru>')
