function Footer() {
  ...
  return (
    <footer className="r-footer" style={{ background: '#070F1B', color: 'rgba(255,255,255,0.45)', padding: '80px 80px 32px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="r-footer__grid" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr 1.2fr', gap: 60, marginBottom: 60 }}>
        <div>
