  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        backgroundImage: `url(${window.__resources && window.__resources.heroBg ? window.__resources.heroBg : 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=2000'})`,
        backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.09,
      }} />
      <div className="grid-bg" />

      <div style={{ flex: 1, display: 'flex', alignItems: 'center', padding: '80px 80px 60px', gap: 56, position: 'relative', zIndex: 2 }}>
        {/* LEFT */}
