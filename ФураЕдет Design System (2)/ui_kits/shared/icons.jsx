// Shared icon set — Lucide-style (1.8 stroke, round joins). Single color via currentColor.
function I(props, children) {
  return React.createElement('svg', {
    width: props.size || 18, height: props.size || 18,
    viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor',
    strokeWidth: props.sw || 1.8, strokeLinecap: 'round', strokeLinejoin: 'round',
    style: props.style
  }, children);
}
...
const Icon = {
  ...
  Dot: (p) => I({ ...p, sw: 0 }, <circle cx="12" cy="12" r="4" fill="currentColor"/>),
  Fire: (p) => I(p, <><path d="M12 2s4 4 4 8a4 4 0 0 1-8 0c0-2 1-3 1-3s-1 5 1 7c0 0-3-1-3-5 0-3 5-7 5-7z"/></>),
